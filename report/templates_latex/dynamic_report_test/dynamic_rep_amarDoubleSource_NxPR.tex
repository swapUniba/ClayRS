...
\BLOCK{if 'field_representations' in my_dict and
          'plot1' in my_dict['field_representations'] and
           my_dict['field_representations']['plot1'].get('preprocessing') is none}
% This block if rendered when no preprocessing technique has been applied
No preprocessing techniques have been used to preprocess data $ plot1 $ during the experiment.
\hfill\break
\hfill\break
\BLOCK{endif}
...
\BLOCK{if 'field_representations' in my_dict and
          'plot2' in my_dict['field_representations'] and
           my_dict['field_representations']['plot2'].get('preprocessing') is none}
% This block if rendered when no preprocessing technique has been applied
No preprocessing techniques have been used to preprocess data $ plot2 $ during the experiment.
\hfill\break
\hfill\break
\BLOCK{endif}
...
\BLOCK{if 'field_representations' in my_dict and
          'video_path0' in my_dict['field_representations'] and
           my_dict['field_representations']['video_path0'].get('preprocessing') is none}
% This block if rendered when no preprocessing technique has been applied
No preprocessing techniques have been used to preprocess data $ video_path0 $ during the experiment.
\hfill\break
\hfill\break
\BLOCK{endif}
...
\BLOCK{if 'field_representations' in my_dict and
          'video_path1' in my_dict['field_representations'] and
           my_dict['field_representations']['video_path1'].get('preprocessing') is none}
% This block if rendered when no preprocessing technique has been applied
No preprocessing techniques have been used to preprocess data $ video_path1 $ during the experiment.
\hfill\break
\hfill\break
\BLOCK{endif}
...
\BLOCK{if 'field_representations' in my_dict and
          'video_path1' in my_dict['field_representations'] and
           my_dict['field_representations']['video_path1'].get('postprocessing') is none}
% This block is rendered if no post processing technique has been applied
No postprocessing techniques have been used on the data $ video_path1 $ in this experiment.
\hfill\break
\hfill\break
\BLOCK{endif}
...
\BLOCK{if 'field_representations' in my_dict and
          'video_path2' in my_dict['field_representations'] and
           my_dict['field_representations']['video_path2'].get('preprocessing') is none}
% This block if rendered when no preprocessing technique has been applied
No preprocessing techniques have been used to preprocess data $ video_path2 $ during the experiment.
\hfill\break
\hfill\break
\BLOCK{endif}
...
\BLOCK{if 'field_representations' in my_dict and
          'video_path2' in my_dict['field_representations'] and
           my_dict['field_representations']['video_path2'].get('postprocessing') is none}
% This block is rendered if no post processing technique has been applied
No postprocessing techniques have been used on the data $ video_path2 $ in this experiment.
\hfill\break
\hfill\break
\BLOCK{endif}
...
\BLOCK{if 'field_representations' in my_dict and
          'video_path3' in my_dict['field_representations'] and
           my_dict['field_representations']['video_path3'].get('preprocessing') is none}
% This block if rendered when no preprocessing technique has been applied
No preprocessing techniques have been used to preprocess data $ video_path3 $ during the experiment.
\hfill\break
\hfill\break
\BLOCK{endif}
...
\BLOCK{if 'field_representations' in my_dict and
          'video_path3' in my_dict['field_representations'] and
           my_dict['field_representations']['video_path3'].get('postprocessing') is none}
% This block is rendered if no post processing technique has been applied
No postprocessing techniques have been used on the data $ video_path3 $ in this experiment.
\hfill\break
\hfill\break
\BLOCK{endif}
...
\BLOCK{if 'field_representations' in my_dict and
          'video_path4' in my_dict['field_representations'] and
           my_dict['field_representations']['video_path4'].get('preprocessing') is none}
% This block if rendered when no preprocessing technique has been applied
...
\BLOCK{if 'field_representations' in my_dict and
          'video_path4' in my_dict['field_representations'] and
           my_dict['field_representations']['video_path4'].get('postprocessing') is none}
% This block is rendered if no post processing technique has been applied
