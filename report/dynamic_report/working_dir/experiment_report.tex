...
\begin{itemize}
    ...
    \item \textbf{fields preprocessing}:  Spacy, NLTK, Ekphrasis, TorchUniformTemporalSubSampler, TorchResample, ConvertToMono, Normalize, Resize, Lambda, CenterCrop, ClipSampler
