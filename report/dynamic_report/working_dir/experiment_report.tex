...
\begin{itemize}
    ...
    \item \textbf{fields preprocessing}:  Spacy, NLTK, Ekphrasis, TorchUniformTemporalSubSampler, ConvertToMono, TorchResample, CenterCrop, Lambda, Normalize, Resize, ClipSampler
