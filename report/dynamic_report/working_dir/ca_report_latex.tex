...
\begin{itemize}
    ...
    \item \textbf{fields preprocessing}:  Spacy, NLTK, Ekphrasis, TorchUniformTemporalSubSampler, ConvertToMono, TorchResample, CenterCrop, Resize, Normalize, Lambda, ClipSampler
