...
\BLOCK{if 'plot_0' in my_dict['field_representations'] and 'SkLearnTfIdf' in my_dict['field_representations']['plot_0'] }
...
\begin{itemize}
    \item max df: \VAR{my_dict['field_representations']['plot_0']['SkLearnTfIdf']['max_df']|safe_text}
    \item min df: \VAR{my_dict['field_representations']['plot_0']['SkLearnTfIdf']['min_df']|safe_text}
    \item max features: \VAR{my_dict['field_representations']['plot_0']['SkLearnTfIdf']['max_features']|safe_text}
    \item vocabulary: \VAR{my_dict['field_representations']['plot_0']['SkLearnTfIdf']['vocabulary']|safe_text}
    \item binary: \VAR{my_dict['field_representations']['plot_0']['SkLearnTfIdf']['binary']|safe_text}
    \item norm: \VAR{my_dict['field_representations']['plot_0']['SkLearnTfIdf']['norm']|safe_text}
    \item use idf: \VAR{my_dict['field_representations']['plot_0']['SkLearnTfIdf']['use_idf']|safe_text}
    \item smooth idf: \VAR{my_dict['field_representations']['plot_0']['SkLearnTfIdf']['smooth_idf']|safe_text}
    \item sublinear tf: \VAR{my_dict['field_representations']['plot_0']['SkLearnTfIdf']['sublinear_tf']|safe_text}
\end{itemize}
\hfill\break
\hfill\break
\BLOCK{endif}
...
\BLOCK{if 'plot_0' in my_dict['field_representations'] and 'NLTK' in my_dict['field_representations']['plot_0']['preprocessing'] }
% NLTK preprocessing
NLTK has been used to preprocess data with the following settings:
\begin{itemize}
    \item strip multiple whitespace: \VAR{my_dict['field_representations']['plot_0']['preprocessing']['NLTK']['strip_multiple_whitespace']|default('no setting used')|safe_text}
    \item remove punctuation: \VAR{my_dict['field_representations']['plot_0']['preprocessing']['NLTK']['remove_punctuation']|default('no setting used')|safe_text}
    \item stopwords removal: \VAR{my_dict['field_representations']['plot_0']['preprocessing']['NLTK']['stopwords_removal']|default('no setting used')|safe_text}
    \item url tagging: \VAR{my_dict['field_representations']['plot_0']['preprocessing']['NLTK']['url_tagging']|default('no setting used')|safe_text}
    \item lemmatization: \VAR{my_dict['field_representations']['plot_0']['preprocessing']['NLTK']['lemmatization']|default('no setting used')|safe_text}
    \item stemming: \VAR{my_dict['field_representations']['plot_0']['preprocessing']['NLTK']['stemming']|default('no setting used')|safe_text}
    \item pos tag: \VAR{my_dict['field_representations']['plot_0']['preprocessing']['NLTK']['pos_tag']|default('no setting used')|safe_text}
    \item lang: \VAR{my_dict['field_representations']['plot_0']['preprocessing']['NLTK']['lang']|default('no setting used')|safe_text}
\end{itemize}
\hfill\break
\hfill\break
\BLOCK{endif}
...
\BLOCK{if 'genres_0' in my_dict['field_representations'] and 'WordEmbeddingTechnique' in my_dict['field_representations']['genres_0'] }
% check WordEmbeddingTechnique used as representation
The Word Embedding Technique has been used and
\BLOCK{ set emb_source = my_dict.get('field_representations', {}).get('genres_0', {}).get('WordEmbeddingTechnique', {}).get('embedding_source', None) }
...
\BLOCK{if 'genres_0' in my_dict['field_representations'] and 'Spacy' in my_dict['field_representations']['genres_0']['preprocessing'] }
% Spacy
Spacy has been used to preprocess data with the following settings:
\begin{itemize}
    \item model: \VAR{my_dict['field_representations']['genres_0']['preprocessing']['Spacy']['model']|default('no setting used')|safe_text}
    \item strip multiple whitespace: \VAR{my_dict['field_representations']['genres_0']['preprocessing']['Spacy']['strip_multiple_whitespace']|default('no setting used')|safe_text}
    \item remove punctuation:\VAR{my_dict['field_representations']['genres_0']['preprocessing']['Spacy']['remove_punctuation']|default('no setting used')|safe_text}
    \item stopwords removal: \VAR{my_dict['field_representations']['genres_0']['preprocessing']['Spacy']['stopwords_removal']|default('no setting used')|safe_text}
    \item new stopwords: \VAR{my_dict['field_representations']['genres_0']['preprocessing']['Spacy']['new_stopwords']|default('no setting used')|safe_text}
    \item not stopwords: \VAR{my_dict['field_representations']['genres_0']['preprocessing']['Spacy']['not_stopwords']|default('no setting used')|safe_text}
    \item lemmatization: \VAR{my_dict['field_representations']['genres_0']['preprocessing']['Spacy']['lemmatization']|default('no setting used')|safe_text}
    \item url tagging: \VAR{my_dict['field_representations']['genres_0']['preprocessing']['Spacy']['url_tagging']|default('no setting used')|safe_text}
    \item named entity recognition: \VAR{my_dict['field_representations']['genres_0']['preprocessing']['Spacy']['named_entity_recognition']|default('no setting used')|safe_text}
\end{itemize}
\hfill\break
\hfill\break
\BLOCK{endif}
...
\BLOCK{if 'genres_1' in my_dict['field_representations'] and 'SentenceEmbeddingTechnique' in my_dict['field_representations']['genres_1'] }
% check SentenceEmbeddingTechnique used as representation
The Sentence Embedding Technique has been used and
\BLOCK{ set emb_src = my_dict.get('field_representations', {}).get('genres_1', {}).get('SentenceEmbeddingTechnique', {}).get('embedding_source', None) }
...
\BLOCK{if 'genres_1' in my_dict['field_representations'] and 'Spacy' in my_dict['field_representations']['genres_1']['preprocessing'] }
% Spacy
Spacy has been used to preprocess data with the following settings:
\begin{itemize}
    \item model: \VAR{my_dict['field_representations']['genres_1']['preprocessing']['Spacy']['model']|default('no setting used')|safe_text}
    \item strip multiple whitespace: \VAR{my_dict['field_representations']['genres_1']['preprocessing']['Spacy']['strip_multiple_whitespace']|default('no setting used')|safe_text}
    \item remove punctuation:\VAR{my_dict['field_representations']['genres_1']['preprocessing']['Spacy']['remove_punctuation']|default('no setting used')|safe_text}
    \item stopwords removal: \VAR{my_dict['field_representations']['genres_1']['preprocessing']['Spacy']['stopwords_removal']|default('no setting used')|safe_text}
    \item new stopwords: \VAR{my_dict['field_representations']['genres_1']['preprocessing']['Spacy']['new_stopwords']|default('no setting used')|safe_text}
    \item not stopwords: \VAR{my_dict['field_representations']['genres_1']['preprocessing']['Spacy']['not_stopwords']|default('no setting used')|safe_text}
    \item lemmatization: \VAR{my_dict['field_representations']['genres_1']['preprocessing']['Spacy']['lemmatization']|default('no setting used')|safe_text}
    \item url tagging: \VAR{my_dict['field_representations']['genres_1']['preprocessing']['Spacy']['url_tagging']|default('no setting used')|safe_text}
    \item named entity recognition: \VAR{my_dict['field_representations']['genres_1']['preprocessing']['Spacy']['named_entity_recognition']|default('no setting used')|safe_text}
\end{itemize}
\hfill\break
\hfill\break
\BLOCK{endif}
...
% ----------------------------------------- CONTENT BASE ALGO ---------------------------------------------------------
\BLOCK{if my_dict['recsys']['ContentBasedRS']['algorithm']['AmarDoubleSource'] is defined}
...
\BLOCK{if my_dict['recsys']['ContentBasedRS']['algorithm']['CentroidVector'] is defined}
...
\BLOCK{if my_dict['recsys']['ContentBasedRS']['algorithm']['ClassifierRecommender'] is defined}
% CLASSIFIER ALGO
...
\BLOCK{if my_dict['recsys']['ContentBasedRS']['algorithm']['IndexQuery'] is defined}
% INDEX QUERY ALGO
...
\BLOCK{if my_dict['recsys']['ContentBasedRS']['algorithm']['LinearPredictor'] is defined}
...
% ------------------------ GRAPH BASED ALGO ------------------------------------------
\BLOCK{if my_dict['recsys']['GraphBasedRS']['algorithm']['NXPageRank'] is defined}
% NX PAGE RANK ALGO
...
\BLOCK{if my_dict['metrics']['Recall'] is defined}
% Recall report start
...
\hfill\break
\hfill\break
% recall report end_______
\BLOCK{endif}


\BLOCK{if my_dict['metrics']['FMeasure'] is defined}
...
\hfill\break
\hfill\break
% FMeasure report end__________
\BLOCK{endif}


\BLOCK{if my_dict['metrics']['PrecisionAtK'] is defined}
...
\BLOCK{if my_dict['metrics']['RecallAtK'] is defined}
...
\hfill\break
\hfill\break
% recall@k report end______
\BLOCK{endif}


\BLOCK{if my_dict['metrics']['FMeasureAtK'] is defined}
...
\BLOCK{if my_dict['metrics']['RPrecision'] is defined}
...
\hfill\break
\hfill\break
% r-precision report end______
\BLOCK{endif}
% <----- classification metrics end ------->

% ------------------ ERROR METRICS STARTED -------------------------------------------

\BLOCK{if my_dict['metrics']['MSE'] is defined}
% MSE REPORT start
...
\hfill\break
\hfill\break
% mse report end_______
\BLOCK{endif}


\BLOCK{if my_dict['metrics']['RMSE'] is defined}
% RMSE REPORT start
...
\hfill\break
\hfill\break
% rmse report end________
\BLOCK{endif}


\BLOCK{if my_dict['metrics']['MAE'] is defined}
% MAE REPORT start
...
\BLOCK{if my_dict['metrics']['NDCG'] is defined}
...
\BLOCK{if my_dict['metrics']['NDCGAtK'] is defined}
% NDCG@K REPORT start
...
\hfill\break
\hfill\break
% ndcg@k report end______
\BLOCK{endif}


\BLOCK{if my_dict['metrics']['MRR'] is defined}
% MRR REPORT start
...
\BLOCK{if my_dict['metrics']['MRRAtK'] is defined}
% MRR@K REPORT start
...
\hfill\break
\hfill\break
% mrr@k report end_______
\BLOCK{endif}


\BLOCK{if my_dict['metrics']['MAP'] is defined}
% MAP REPORT start
...
\hfill\break
\hfill\break
% map report end_______
\BLOCK{endif}


\BLOCK{if my_dict['metrics']['MAPAtK'] is defined}
% MAP@K REPORT start
...
\hfill\break
\hfill\break
% map@k report end_______
\BLOCK{endif}


\BLOCK{if my_dict['metrics']['Correlation'] is defined}
...
\hfill\break
\hfill\break
% correlation report end_____
\BLOCK{endif}
% <------- ranking metrics ended ------->


% ------------------------- FAIRNESS METRICS ------------------------------------
\BLOCK{if my_dict['metrics']['GiniIndex'] is defined}
...
\hfill\break
\hfill\break
% gini index report end_____
\BLOCK{endif}


\BLOCK{if my_dict['metrics']['PredictionCoverage'] is defined}
...
\hfill\break
\hfill\break
% prediction coverage report end________
\BLOCK{endif}


\BLOCK{if my_dict['metrics']['CatalogCoverage'] is defined}
...
\hfill\break
\hfill\break
% catalog coverage report end________
\BLOCK{endif}


\BLOCK{if my_dict['metrics']['DeltaGap'] is defined}
...
\hfill\break
\hfill\break
% delta gap report end_______
\BLOCK{endif}
% <----- fairness metrics end ------>


% --------------------------------- PLOT METRICS STARTED ----------------------------------------------
\BLOCK{if my_dict['metrics']['LongTailDistr'] is defined}
...
\hfill\break
\hfill\break
% LTD report end_______
\BLOCK{endif}


\BLOCK{if my_dict['metrics']['PopRatioProfileVsRecs'] is defined}
...
\hfill\break
\hfill\break
%PopRatioProfileVsRecs report end_______
\BLOCK{endif}


\BLOCK{if my_dict['metrics']['PopRecsCorrelation'] is defined}
...
\hfill\break
\hfill\break
% PopRecsCorrelation report end_________
\BLOCK{endif}
% <------- plot metric end ----------->
