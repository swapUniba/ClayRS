...
\BLOCK{if my_dict is defined and
      ...
      'X' in my_dict['field_representations'] and
      my_dict['field_representations']['X'] is defined and
      'WhooshTfIdf' in my_dict['field_representations']['X']}
...
\BLOCK{if my_dict is defined and
      ...
      'X' in my_dict['field_representations'] and
      my_dict['field_representations']['X'] is defined and
      'WordEmbeddingTechnique' in my_dict['field_representations']['X']}
...
\BLOCK{if my_dict is defined and
      ...
      'X' in my_dict['field_representations'] and
      my_dict['field_representations']['X'] is defined and
      'DocumentEmbeddingTechnique' in my_dict['field_representations']['X']}
...
\BLOCK{if my_dict is defined and
      ...
      'X' in my_dict['field_representations'] and
      my_dict['field_representations']['X'] is defined and
      'Word2SentenceEmbedding' in my_dict['field_representations']['X']}
...
\BLOCK{if my_dict is defined and
      ...
      'X' in my_dict['field_representations'] and
      my_dict['field_representations']['X'] is defined and
      'Word2DocEmbedding' in my_dict['field_representations']['X']}
...
\BLOCK{if my_dict is defined and
      ...
      'X' in my_dict['field_representations'] and
      my_dict['field_representations']['X'] is defined and
      'Sentence2DocEmbedding' in my_dict['field_representations']['X']}
...
\BLOCK{if my_dict is defined and
      ...
      'X' in my_dict['field_representations'] and
      my_dict['field_representations']['X'] is defined and
      'PyWSDSynsetDocumentFrequency' in my_dict['field_representations']['X']}
...
\BLOCK{if my_dict is defined and
      ...
      'X' in my_dict['field_representations'] and
      my_dict['field_representations']['X'] is defined and
      'FromNPY' in my_dict['field_representations']['X']}
...
\BLOCK{if my_dict is defined and
      ...
      'X' in my_dict['field_representations'] and
      my_dict['field_representations']['X'] is defined and
      'MFCC' in my_dict['field_representations']['X']}
...
\BLOCK{if my_dict is defined and
      ...
      'X' in my_dict['field_representations'] and
      my_dict['field_representations']['X'] is defined and
      'TorchVisionVideoModels' in my_dict['field_representations']['X']}
...
\BLOCK{if my_dict is defined and
      ...
      'Spacy' in my_dict['field_representations']['X']['preprocessing']}
% Spacy
...
\BLOCK{if my_dict is defined and
      ...
      'preprocessing' in my_dict['field_representations']['X'] and
      my_dict['field_representations']['X']['preprocessing'] is defined and
      'Ekphrasis' in my_dict['field_representations']['X']['preprocessing']}
% Ekphrasis
...
\BLOCK{if my_dict is defined and
      ...
      'preprocessing' in my_dict['field_representations']['X'] and
      my_dict['field_representations']['X']['preprocessing'] is defined and
      'NLTK' in my_dict['field_representations']['X']['preprocessing']}
% NLTK preprocessing
...
\BLOCK{if my_dict is defined and
      ...
      'preprocessing' in my_dict['field_representations']['X'] and
      my_dict['field_representations']['X']['preprocessing'] is defined and
      'TorchUniformTemporalSubSampler' in my_dict['field_representations']['X']['preprocessing']}
...
\BLOCK{if my_dict is defined and
      ...
      my_dict['field_representations']['X'] is defined and
      'preprocessing' in my_dict['field_representations']['X'] and
      'ConvertToMono' in my_dict['field_representations']['X']['preprocessing']}
...
\BLOCK{if my_dict is defined and
      ...
      my_dict['field_representations']['X'] is defined and
      'preprocessing' in my_dict['field_representations']['X'] and
      'CenterCrop' in my_dict['field_representations']['X']['preprocessing']}
...
\BLOCK{if my_dict is defined and
      ...
      my_dict['field_representations']['X'] is defined and
      'preprocessing' in my_dict['field_representations']['X'] and
      'Lambda' in my_dict['field_representations']['X']['preprocessing']}
...
\BLOCK{if my_dict is defined and
      ...
      my_dict['field_representations']['X'] is defined and
      'preprocessing' in my_dict['field_representations']['X'] and
      'Normalize' in my_dict['field_representations']['X']['preprocessing']}
...
\BLOCK{if my_dict is defined and
      ...
      my_dict['field_representations']['X'] is defined and
      'preprocessing' in my_dict['field_representations']['X'] and
      'ClipSampler' in my_dict['field_representations']['X']['preprocessing']}
...
\BLOCK{ if my_dict is defined and
      ...
      my_dict['field_representations']['X'] is defined and
      'preprocessing' in my_dict['field_representations']['X'] and
      my_dict['field_representations']['X']['preprocessing'] is none}
...
\BLOCK{if my_dict is defined and
      ...
      '1' in my_dict['field_representations']['X']['postprocessing'] and
      'FVGMM' in my_dict['field_representations']['X']['postprocessing']['1']}
...
\BLOCK{if my_dict is defined and
      ...
      'X' in my_dict['field_representations'] and
      'postprocessing' in my_dict['field_representations']['X'] and
      '3' in my_dict['field_representations']['X']['postprocessing'] and
      'SkLearnPCA' in my_dict['field_representations']['X']['postprocessing']['3']}
...
\hfill\break
\hfill\break
% principal class algorithm end_____
\BLOCK{endif}

% ----------------------------------------- CONTENT BASE ALGO ---------------------------------------------------------
\BLOCK{if my_dict['recsys'] is defined and
      my_dict['recsys']['ContentBasedRS'] is defined and
      my_dict['recsys']['ContentBasedRS']['algorithm'] is defined and
...
\BLOCK{if my_dict['recsys'] is defined and
      ...
      my_dict['recsys']['GraphBasedRS']['algorithm'] is defined and
