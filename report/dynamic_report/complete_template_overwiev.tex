...
\BLOCK{if 'X' in my_dict['field_representations'] and my_dict['field_representations']['X'].get('postprocessing') is none }
...
\hfill\break
\hfill\break
% KFOLD PARTITIONING TECNIQUE ended___
\BLOCK{endif}
...
\hfill\break
\hfill\break
%  HOLD-OUT PARTIONING TECNIQUE ended___
\BLOCK{endif}
% end partitioning section___
...
\hfill\break
\hfill\break
% principal class algorithm end___
\BLOCK{endif}
...
% -------------------- THIS LATEX TEMPLATE REPORT THE RISULTS OF THE SYSTEMS ON THE FOLD USED ------------------------
