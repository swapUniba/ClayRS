...
\BLOCK{if 'X' in my_dict['field_representations'] and 'SentenceEmbeddingTechnique' in my_dict['field_representations']['X'] }
...
\BLOCK{if 'X' in my_dict['field_representations'] and 'DocumentEmbeddingTechnique' in my_dict['field_representations']['X'] }
...
\BLOCK{if 'X' in my_dict['field_representations'] and 'SkImageHogDescriptor' in my_dict['field_representations']['X'] }
...
\BLOCK{if 'X' in my_dict['field_representations'] and 'VGGISH' in my_dict['field_representations']['X'] }
...
\BLOCK{if  'X' in my_dict['field_representations'] and 'TorchVisionVideoModels' in my_dict['field_representations']['X']}
...
\hfill\break
\BLOCK{endif}
% --- ends fields representation techniques -----
...
\BLOCK{if 'X' in my_dict['field_representations'] and 'TorchUniformTemporalSubSampler' in my_dict['field_representations']['X']['preprocessing'] }
...
\BLOCK{if 'X' in my_dict['field_representations'] and 'TorchResample' in my_dict['field_representations']['X']['preprocessing'] }
...
\BLOCK{if 'X' in my_dict['field_representations'] and 'ConvertToMono' in my_dict['field_representations']['X']['preprocessing'] }
...
\BLOCK{if 'X' in my_dict['field_representations'] and 'Resize' in my_dict['field_representations']['X']['preprocessing'] }
...
\BLOCK{if 'X' in my_dict['field_representations'] and 'CenterCrop' in my_dict['field_representations']['X']['preprocessing'] }
...
\BLOCK{if 'X' in my_dict['field_representations'] and 'Lambda' in my_dict['field_representations']['X']['preprocessing'] }
...
\BLOCK{if 'X' in my_dict['field_representations'] and 'Normalize' in my_dict['field_representations']['X']['preprocessing'] }
...
\BLOCK{if 'X' in my_dict['field_representations'] and my_dict['field_representations']['X']['preprocessing'] is none}
No preprocessing techniques have been used to preprocess data X during the experiment.
\hfill\break
\hfill\break
\BLOCK{endif}
% ----------- ends pre processing techniques --------------
...
\BLOCK{if in my_dict['field_representations'] and 'VLADGMM' in my_dict['field_representations']['X']['postprocessing']['2']}
...
\BLOCK{if 'X' in my_dict['field_representations'] and my_dict['field_representations']['X']['postprocessing'] is none}
