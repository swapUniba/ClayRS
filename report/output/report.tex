...
\begin{itemize}
    \item omit: None
    \item normalize: None
    \item unpack contractions: False
    \item unpack hashtags: False
    \item annotate: None
    \item corrector: None
    \item tokenizer:
    \item segmenter: None
    \item all caps tag: None
    \item spell correction: True
    \item segmentation: False
    \item dicts: None
    \item spell correct elong: True
\end{itemize}
\hfill\break
\hfill\break
% Ekphrasis end___
...
\begin{itemize}
    \item new freq: 16000
    \item resampling method: sinc\_interp\_hann
    \item lowpass filter width: 6
    \item roll off: 0.99
    \item beta: None
\end{itemize}
\hfill\break
...
\begin{itemize}
    \item number of frames for clip: 16
    \item number of clips: 5
    \item selection strategy: sequential
\end{itemize}
\hfill\break
\hfill\break
% ClipSampler end___
