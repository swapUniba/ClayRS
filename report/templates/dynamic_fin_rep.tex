...
\BLOCK{if my_dict is defined and
      ...
      my_dict['field_representations']['plot_0'] is defined and
      'SkLearnTfIdf' in my_dict['field_representations']['plot_0']}
...
\BLOCK{if my_dict is defined and
      ...
      'NLTK' in my_dict['field_representations']['plot_0']['preprocessing']}
% NLTK preprocessing
...
\BLOCK{if my_dict is defined and
      ...
      my_dict['field_representations']['genres_0'] is defined and
      'WordEmbeddingTechnique' in my_dict['field_representations']['genres_0']}
...
\BLOCK{if my_dict is defined and
      ...
      'Spacy' in my_dict['field_representations']['genres_0']['preprocessing']}
% Spacy preprocessing
...
\BLOCK{if my_dict is defined and
      ...
      my_dict['field_representations']['genres_1'] is defined and
...
\BLOCK{if my_dict is defined and
      ...
      'Spacy' in my_dict['field_representations']['genres_1']['preprocessing']}
% Spacy preprocessing
Spacy has been used to preprocess data with the following settings:
\begin{itemize}
