...
class TestGensimDownloader(TestCase):
    def test_load(self):
        ...
        for v in result:
            ...
            # so n = 1
            top_1 = source.model.similar_by_vector(v, 1)[0]
            words.append(top_1)
        ...
        # words contains [(title, 1.0), (plot, 1.0000001192092896)]
        ...
        self.assertEqual(first_word, "title")
        self.assertAlmostEqual(first_like, 1, delta=1e-6)
        self.assertEqual(second_word, "plot")
